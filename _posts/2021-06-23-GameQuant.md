...
- **결과 시각화 (위의 영상은 v1.2 아래는 비교를 위한 v1.1)**
    ...
    ![images/output_sample_v1.2.gif](/_posts/images/output_sample_v1.2.gif)

    ![images/JgPos_v1.1.gif](/_posts/images/JgPos_v1.1.gif)


2. 샘플 영상 추가 및 결과 시각화

- ![images/output_sample2_v1.2.gif](/_posts/images/output_sample2_v1.2.gif)
